...
export const Listado = () => {
  const [ciudadCanje, setCiudadCanje] = useState("bogotá");
  return (
    <>
      <div>
        <div className=" w-full flex flex-col gap-4 justify-center items-center py-16">
          ...
          <div className=" px-80 py-10 sm:max-md:px-5">
            ...
            <div className="flex flex-col gap-10 justify-center items-center pt-5">
              <ul className="list-disc list-inside font-AltoneNormal text-justify">
                <li>Tarjeta original con logotipo del club emisor</li>
                <li>Nombre completo del socio solicitante</li>
                <li>El canje no da derecho a la firma de vales.</li>
                <li>
                  Nombre completo de los beneficios que podrán hacer uso del
                  canje. * Número del derecho de socio
                </li>
                <li>Fecha de expedición del canje</li>
                <li>Nombre del club destino</li>
                <li>Firma autorizada y sello correspondiente</li>
              </ul>
            </div>
            <div className="flex flex-col pt-20 justify-center items-center gap-10 px-10">
              ...
              <div className="flex flex-col gap-10 justify-center items-center">
                <p className="text-xl font-thin italic">
                  De martes a Sábado de 7:00 a.m. a 12:30 y 1:30 a 5:00 p.m.
                </p>
