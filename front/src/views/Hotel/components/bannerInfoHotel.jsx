  ...
  return (
    <>
      <div className=' w-full 2xl:h-[50rem] xl:h-[40rem] lg:h-[40rem]  z-10 flex top-0'>
        ...
        <div className=' w-full 2xl:h-[25rem] lg:h-[20rem] absolute z-30 2xl:top-[23%] xl:top-[30%] lg:top-[25%] top-[45%] sm:max-md:top-[30%] animate__animated animate__fadeInDown '>
